...
class HomePage extends BasePage {
  ...
  get checkingAccount() {
    return $('#checking-menu');
  }
  get newCheckingBtn() {
    return $('#new-checking-menu-item');
  }
  get depositMenuBtn() {
    return $('#deposit-menu-item');
  }
  get withdrawMenuBtn() {
    return $('#withdraw-menu-item');
  }
  get creditMenu() {
    return $('#credit-menu');
  }
  get btnCerrarSesion() {
    return $("a[href='/bank/logout']");
  }
  get welcomeMessage() {
    return $('.active');
  }
  get btnDeleteData() {
    return $("//a[@href='/bank/user/delete-data']");
  }
  ...
  async irAWithdrawMenu() {
    ...
    await this.clickearElemento(this.withdrawMenuBtn);
  }
  ...
  async clickNewApplicationMenuItem() {
    const newApplicationMenuItem = $('#new-credit-application-menu-item');
  ...
  async clickDeleteData() {
    ...
    await this.clickearElemento(this.userAvatar);
    await this.clickearElemento(this.btnDeleteData);
  }
}
